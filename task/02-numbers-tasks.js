...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    return Math.acos((x1 * x2 + y1 * y2) /(getDistanceBetweenPoints(x1, 0, y1, 0) * getDistanceBetweenPoints(x2, 0, y2, 0)))
}
 ...
 */
function isPrime(n) {
    for (let i = 2; i <= Math.pow(n, 0.5); i++) if(n % i == 0) return false
    return true
}
